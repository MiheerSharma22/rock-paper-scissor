  ...
  return (
    ...
    createPortal(
      <div className="top-0 left-0 right-0 bottom-0 bg-[#00000088] absolute flex felx-col justify-center items-center">
        <div className="bg-[#fff] w-[90%] h-[80%] md:px-[1rem] md:w-[30%] md:h-[55%] flex flex-col justify-around items-center rounded-lg">
          <img src={rules} alt="rules" />

          <button
            onClick={onClose}
            className="rounded-full p-[0.75rem] bg-[#0000001d] hover:bg-[#00000032] transition-all duration-200"
          >
